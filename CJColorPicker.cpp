...
CCJColorPicker::CCJColorPicker()
{
	...
	////////////////////////////////////////
	m_crDefaultBkColor = ::GetSysColor(COLOR_3DLIGHT);
}
...
BOOL CCJColorPicker::OnClicked()
{
	...
	new CCJColorPopup(CPoint(rect.left, rect.bottom),    // Point to display popup
		...
		m_crDefaultBkColor,               // 默认色，added by liming
		this,                              // parent
...
void CCJColorPicker::SetBkColorDefault( COLORREF crColorBk )
{
	m_crDefaultBkColor = crColorBk;
}
