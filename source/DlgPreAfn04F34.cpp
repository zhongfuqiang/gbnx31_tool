// DlgPreAfn04F34.cpp : implementation file
//
...
CDlgPreAfn04F34::CDlgPreAfn04F34(CWnd* pParent /*=NULL*/)
	: CDialog(CDlgPreAfn04F34::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlgPreAfn04F34)
		// NOTE: the ClassWizard will add member initialization here
	//}}AFX_DATA_INIT

	//m_strPrecise[MC_PREC_UNKOWN] = "未知精度";
...
void CDlgPreAfn04F34::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlgPreAfn04F34)
...
BEGIN_MESSAGE_MAP(CDlgPreAfn04F34, CDialog)
	//{{AFX_MSG_MAP(CDlgPreAfn04F34)
	ON_CBN_EDITCHANGE(IDC_CMBO_PREC, OnEditchangeCmboPrec)
	ON_CBN_SELENDOK(IDC_CMBO_PREC, OnSelendokCmboPrec)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CDlgPreAfn04F34 message handlers

void CDlgPreAfn04F34::OnOK() 
{
...
BOOL CDlgPreAfn04F34::OnInitDialog() 
{
...
void CDlgPreAfn04F34::OnEditchangeCmboPrec() 
{
...
void CDlgPreAfn04F34::OnSelendokCmboPrec() 
{
	// TODO: Add your control notification handler code here
	int i = 0;
...
// 将之前存过的值读入并显示在界面上
void CDlgPreAfn04F34::GetCurValues()
{
		CNxConfig cfg;
		sMcAfn04f34 sAfn04f34;		
		cfg.GetPreAfn04F34(&sAfn04f34, TRUE);
		SetNelcType(sAfn04f34.eType);
		

		// 精度
		m_comb_prec.SetCurSel(sAfn04f34.sUp.ePrec-1);
...
// 设置界面上用户的设置并存入注册表
void CDlgPreAfn04F34::SetNewValues()
{
	CNxConfig cfg;
	sMcAfn04f34 sAfn04f34;	
	eMcNElcType eType;
	GetNelcType(eType);
	sAfn04f34.eType = eType;
	sAfn04f34.sUp.ePrec = (eMcPrecise)(m_comb_prec.GetCurSel() + 1);
	sAfn04f34.sDown.ePrec = sAfn04f34.sUp.ePrec;
	
	CString strUp,strDn;
	m_edit_up.GetWindowText(strUp);
	m_edit_dn.GetWindowText(strDn);

	sAfn04f34.sUp.dValue = atof(strUp.GetBuffer(strUp.GetLength()));
	strUp.ReleaseBuffer();

	sAfn04f34.sDown.dValue = atof(strDn.GetBuffer(strDn.GetLength()));
	strDn.ReleaseBuffer();
	
	cfg.SetPreAfn04F34(&sAfn04f34, TRUE, TRUE);
}


// 
void CDlgPreAfn04F34::SetNelcType(eMcNElcType eNelctype)
{
...
void CDlgPreAfn04F34::GetNelcType( eMcNElcType &eNelctype )
{
	BOOL  bCheck = FALSE;
